...
function Header() {
    ...
    return (
        ...
        <motion.div className='flex flex-col justify-center items-center text-center my-20 '
            ...
            <motion.button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full' initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <motion.div
                ...
                className='flex flex-wrap just-center mt-16 gap-3'>
                {Array(6).fill('').map((item, index) => (
                    <motion.img
                        whileHover={{ scale: 1.05, duration: 0.1 }}
                        src={index % 2 === 0 ? assets.sample_img_1 : assets.sample_img_2} className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10' key={index} width={70}>
            ...
            <motion.p
                ...
                className='mt-2 text-neutral-600'>Generated Images From AI Imagify</motion.p>
        </motion.div>
    )
}
